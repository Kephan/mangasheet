<?php 
    ...
    $count = "SELECT COUNT(*) as total FROM mangas";
    ...
    $sql = "SELECT a.ColID, a.titulo_coleccion, a.titulo_original, a.editorial, a.volumenes_japon, a.volumenes_es, a.idioma, a.autor, a.artista, a.sinopsis, b.esnovela, b.volumen, b.precio, b.fecha, b.paginas, b.portada, b.ed_especial, c.editorial, d.demografia FROM colecciones a LEFT JOIN mangas b ON b.coleccion = a.ColID LEFT JOIN editoriales c ON c.ID = a.editorial LEFT JOIN demografias d ON d.demoID = a.demografia ORDER BY b.fecha DESC LIMIT $page, 10"; 
                ...
                <div class="inner">
                    <div class="inner-content <?php echo strtolower($row["demografia"])?>">
                        ...
                        <?php if($row['esnovela'] == 0) { ?>
                            <div class="tag is-manga">Manga <?php echo ($all["total"] / 10 + 1); ?> </div>
                        <?php }else { ?>
